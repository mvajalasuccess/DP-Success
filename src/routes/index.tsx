    ...
    <div className="min-h-screen bg-background">
      <aside className="fixed inset-y-0 left-0 hidden w-60 border-r bg-sidebar lg:block">
        ...
        <nav className="space-y-1 p-3 text-sm">
          ...
          {["Funcionários","Departamentos","Cargos","Jornadas / Escalas","Fechamento de Ponto","Lançamentos","Banco de Horas","Atestados","Faltas e Ocorrências","Relatórios","Comparativos","KPIs","Configurações"].map(item=>item==="Funcionários" ? <Link key={item} to="/funcionarios" className="block rounded-lg px-3 py-2.5 text-sidebar-foreground/75 hover:bg-sidebar-accent">{item}</Link> : item==="Departamentos" ? <Link key={item} to="/departamentos" className="block rounded-lg px-3 py-2.5 text-sidebar-foreground/75 hover:bg-sidebar-accent">{item}</Link> : item==="Cargos" ? <Link key={item} to="/cargos" className="block rounded-lg px-3 py-2.5 text-sidebar-foreground/75 hover:bg-sidebar-accent">{item}</Link> : item==="Jornadas / Escalas" ? <Link key={item} to="/jornadas-escalas" className="block rounded-lg px-3 py-2.5 text-sidebar-foreground/75 hover:bg-sidebar-accent">{item}</Link> : item==="Lançamentos" ? <Link key={item} to="/lancamentos" className="block rounded-lg px-3 py-2.5 text-sidebar-foreground/75 hover:bg-sidebar-accent">{item}</Link> : item==="Fechamento de Ponto" ? <Link key={item} to="/fechamento-ponto" className="block rounded-lg px-3 py-2.5 text-sidebar-foreground/75 hover:bg-sidebar-accent">{item}</Link> : item==="Atestados" ? <Link key={item} to="/atestados" className="block rounded-lg px-3 py-2.5 text-sidebar-foreground/75 hover:bg-sidebar-accent">{item}</Link> : item==="Faltas e Ocorrências" ? <Link key={item} to="/ocorrencias" className="block rounded-lg px-3 py-2.5 text-sidebar-foreground/75 hover:bg-sidebar-accent">{item}</Link> : item==="KPIs" ? <Link key={item} to="/kpis" className="block rounded-lg px-3 py-2.5 text-sidebar-foreground/75 hover:bg-sidebar-accent">{item}</Link> : item==="Relatórios" ? <Link key={item} to="/relatorios" className="block rounded-lg px-3 py-2.5 text-sidebar-foreground/75 hover:bg-sidebar-accent">{item}</Link> : item==="Parâmetros" ? <Link key={item} to="/parametros" className="block rounded-lg px-3 py-2.5 text-sidebar-foreground/75 hover:bg-sidebar-accent">{item}</Link> : item==="Comparativos" ? <Link key={item} to="/comparativos" className="block rounded-lg px-3 py-2.5 text-sidebar-foreground/75 hover:bg-sidebar-accent">{item}</Link> : item==="Banco de Horas" ? <Link key={item} to="/banco-horas" className="block rounded-lg px-3 py-2.5 text-sidebar-foreground/75 hover:bg-sidebar-accent">{item}</Link> : <div key={item} className="rounded-lg px-3 py-2.5 text-sidebar-foreground/75 hover:bg-sidebar-accent">{item}</div>)}
        </nav>
      </aside>
