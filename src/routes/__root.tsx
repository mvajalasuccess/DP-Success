...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "DP Success · RH e Departamento Pessoal" },
      { name: "description", content: "Sistema de RH e Departamento Pessoal para gestão de ponto, banco de horas, absenteísmo e indicadores." },
      { name: "author", content: "DP Success" },
      { property: "og:title", content: "DP Success · RH e Departamento Pessoal" },
      { property: "og:description", content: "Gestão de RH, ponto, banco de horas e indicadores." },
...
function RootComponent() {
  ...
  }, [checkingAuth, session, location.pathname, navigate]);
