...
import { Outlet, Link, createRootRouteWithContext, useRouter, useNavigate, useLocation, HeadContent, Scripts } from "@tanstack/react-router";
...
export const Route=createRootRouteWithContext<{queryClient:QueryClient}>()({head:()=>({meta:[{charSet:"utf-8"},{name:"viewport",content:"width=device-width, initial-scale=1"},{title:"DP Success · RH e Departamento Pessoal"},{name:"description",content:"Sistema de RH e Departamento Pessoal para gestão de ponto, banco de horas, absenteísmo e indicadores."},{name:"author",content:"DP Success"},{property:"og:title",content:"DP Success · RH e Departamento Pessoal"},{property:"og:description",content:"Gestão de RH, ponto, banco de horas e indicadores."},{property:"og:type",content:"website"},{name:"twitter:card",content:"summary_large_image"},{name:"twitter:site",content:"@Lovable"}],links:[{rel:"stylesheet",href:appCss},{rel:"icon",href:"/favicon.ico",type:"image/x-icon"}]}),shellComponent:RootShell,component:RootComponent,notFoundComponent:NotFoundComponent,errorComponent:ErrorComponent});
